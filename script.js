...
if (myGame === 1) {
  ...
  let currentGuess = [];
  let nextLetter = 0;
  let rightGuessString = MYWORD8[Math.floor(Math.random() * MYWORD8.length)];
  ...
  function checkGuess() {
    ...
    if (!WORDS8.includes(guessString)) {
      toastr.error("Word not in list!");
      return;
    }
  
    var letterColor = ["gray", "gray", "gray", "gray", "gray", "gray", "gray", "gray"];
  ...
  let currentGuess = [];
  let nextLetter = 0;
  let rightGuessString = MYWORD9[Math.floor(Math.random() * MYWORD9.length)];
  ...
  function checkGuess() {
    ...
    if (guessString.length != 9) {
      toastr.error("Not enough letters!");
      return;
    }
  
    if (!WORDS9.includes(guessString)) {
      toastr.error("Word not in list!");
      return;
    }
  
    var letterColor = ["gray", "gray", "gray", "gray", "gray", "gray", "gray", "gray", "gray"];
